...
?></title>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo SimpleSAML_Module::getModuleURL('cvve/cvve.css'); ?>" />
...
<div id="wrap">
	...
	<div id="header">
		<h1><a style="text-decoration: none; color: white;" href="/<?php echo $this->data['baseurlpath']; ?>"><img src="<?php echo SimpleSAML_Module::getModuleURL('cvve/logo.png'); ?>" alt="CVVE" /></a></h1>
	</div>
